          ...
          >
            ...
            <div className="space-y-8 mb-12">
              <ContactInfo 
                icon={Mail} 
                title="Email Us" 
                content="contact@solveitbytech.com" 
              />
              <ContactInfo 
                icon={Phone} 
                title="Call Us" 
              ...
              <ContactInfo 
                icon={MapPin} 
                title="Visit Us" 
                content="Tech Park, Bangalore, Karnataka, India" 
              />
            </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="John Doe" {...field} className="bg-background/50 border-white/10 h-12 rounded-xl focus:border-primary" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="john@example.com" type="email" {...field} className="bg-background/50 border-white/10 h-12 rounded-xl focus:border-primary" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="bg-secondary border-white/10">
                          {services.map(service => (
                            <SelectItem key={service} value={service} className="focus:bg-primary/20">{service}</SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                      <FormMessage />
